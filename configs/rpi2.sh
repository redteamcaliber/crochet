...
#   file=/usr/swap0 - Set the filename of the swap file.  The default
#          name is /usr/swap0.
#
#option SwapFile <size> [deferred] [file=/usr/swap0]
